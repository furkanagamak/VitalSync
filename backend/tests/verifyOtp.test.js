const {
  ...
  describe("POST /verifyOtp OTP verification endpoint testing", () => {
    ...
    it("Valid OTP should verify successfully", async () => {
      ...
      await mongoose.model("Account").updateOne({ email: dummyEmail }, {
        "otp.code": testOtp,
      ...
      expect(otpRes.body.message).toEqual("OTP code verified successfully. You can now reset your password.");
    });
